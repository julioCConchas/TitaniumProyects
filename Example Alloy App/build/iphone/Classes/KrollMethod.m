...
-(id)call:(NSArray*)args
{
	...
	{
		@throw [NSException exceptionWithName:@"org.googleauthalloy.kroll" reason:[NSString stringWithFormat:@"invalid method '%@'",NSStringFromSelector(selector)] userInfo:nil];
	}
	id arg1=nil;
	id arg2=nil;
