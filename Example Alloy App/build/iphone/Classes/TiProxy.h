...
//Rare exceptions to indicate a bug in the _googleauthalloy code (Eg, function that a subclass should have implemented)
...
/**
 The base class for GoogleAuthAlloy proxies.
 */
