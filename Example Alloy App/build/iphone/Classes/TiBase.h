...
// in simulator we redefine to format for GoogleAuthAlloy Developer console
...
{\
	NSString * exceptionName = [@"org.googleauthalloy." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.googleauthalloy";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIGoogleAuthAlloyNativeItemNone = -1, 
	UIGoogleAuthAlloyNativeItemSpinner = -2,
	UIGoogleAuthAlloyNativeItemProgressBar = -3,
	
	UIGoogleAuthAlloyNativeItemSlider = -4,
	UIGoogleAuthAlloyNativeItemSwitch = -5,
	UIGoogleAuthAlloyNativeItemMultiButton = -6,
	UIGoogleAuthAlloyNativeItemSegmented = -7,
	
	UIGoogleAuthAlloyNativeItemTextView = -8,
	UIGoogleAuthAlloyNativeItemTextField = -9,
	UIGoogleAuthAlloyNativeItemSearchBar = -10,
	
	UIGoogleAuthAlloyNativeItemPicker = -11,
	UIGoogleAuthAlloyNativeItemDatePicker = -12,
	
	UIGoogleAuthAlloyNativeItemInfoLight = -13,
	UIGoogleAuthAlloyNativeItemInfoDark = -14,
	
	UIGoogleAuthAlloyNativeItemDisclosure = -15,
	
	UIGoogleAuthAlloyNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GoogleAuthAlloy instances of
