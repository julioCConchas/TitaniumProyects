...
/**
 Base class for all GoogleAuthAlloy views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the GoogleAuthAlloy view hierarchy (such as wrapped iOS UIViews) was touched.
