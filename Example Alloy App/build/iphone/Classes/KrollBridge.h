...
@interface GoogleAuthAlloyObject : KrollCoverageObject {
#else
@interface GoogleAuthAlloyObject : KrollObject {
#endif
@private
...
extern NSString * GoogleAuthAlloy$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	GoogleAuthAlloyObject *_googleauthalloy;
    KrollObject* console;
	BOOL shutdown;
