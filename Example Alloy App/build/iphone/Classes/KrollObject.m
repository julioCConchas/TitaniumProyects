...
//@interface GoogleAuthAlloyObject : NSObject
//@end

@interface GoogleAuthAlloyObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[GoogleAuthAlloyObject class]])
		{
			for (NSString *key in [[(GoogleAuthAlloyObject*)o modules] allKeys])
			{
